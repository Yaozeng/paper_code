...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default='saved_models/origin')
...
if __name__ == '__main__':
    ...
    train_dset = VQAFeatureDataset('train', dictionary, adaptive=False)
    val_dset = VQAFeatureDataset('val', dictionary, adaptive=False)
