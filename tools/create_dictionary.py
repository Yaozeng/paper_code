...
if __name__ == '__main__':
    d = create_dictionary2('data')
    d.dump_to_file('data/cocodictionary.pkl')

    d = Dictionary.load_from_file('data/cocodictionary.pkl')
    emb_dim = 300
    glove_file = 'data/glove.6B.%dd.txt' % emb_dim
    weights, word2emb = create_glove_embedding_init(d.idx2word, glove_file)
    np.save('data/cocoglove6b_init_%dd.npy' % emb_dim, weights)
