...
train_data_file = 'data/cocotrain36.hdf5'
val_data_file = 'data/cocoval36.hdf5'
train_indices_file = 'data/cocotrain36_imgid2idx.pkl'
val_indices_file = 'data/cocoval36_imgid2idx.pkl'
train_ids_file = '/data1/YZ/new_model/tools/cocotrain_ids.pkl'
val_ids_file = '/data1/YZ/new_model/tools/cocoval_ids.pkl'
